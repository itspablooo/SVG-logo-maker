...
describe('circle', () => {
    it('Should make a circle with specified shape color, text, and text color', () => {
        const testCircle = `<svg> version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="100" r="80" fill="GREEN"/><text x="150" y="125" font-size="60" text-anchor="middle" fill="WHITE">SVG</text></svg>`;
...
describe('square', () => {
    it('Should make a square with specified shape color, text, and text color', () => {
        const testSquare = `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="BLUE"/><text x="50" y="60" font-size="40" text-anchor="middle" fill="RED">SVG</text></svg>`;
